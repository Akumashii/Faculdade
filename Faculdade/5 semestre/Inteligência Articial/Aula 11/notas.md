...
Seleção é feita com base em uma porcentagem pequena da população, enquanto o resto é descartado. Também e feita uma seleção sortida com peso, os mais aptos tem maior probabilidade de serem selecionados. Toda tarefa de busca ou otimização possui:
...
- Busca de Soluções em Espaço de Estados
	...
	- Os operadores ou rergas de transição de estados são MECANISMOS DE SELEÇÃO E DE REPRODUÇÃO que tentam encontrar melhores soluções (ou indivíduos)
