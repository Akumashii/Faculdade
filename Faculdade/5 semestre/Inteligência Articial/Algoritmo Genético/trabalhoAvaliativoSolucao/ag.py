...
class AG:
    ...
    def gerar_populacao(populacao, tamanho_populacao):
        ...
        for i in range(tamanho_populacao):
            ...
            populacao.append(Cromossomo(copy.deepcopy(rota))) #deepcopy faz uma cópia da rota para não alterar a rota original, perigo de apontar para o mesmo espaço de memória
            rota.clear()
